...
#k1=0.7, k2=0.7, scale=0.66 #Barral Low
#k1=2.5, k2=2.5, scale=0.35 #Barral High
...
def distort_barrel_low(img_h, img_w):
    return distort_barrel(img_h, img_w, k1=0.7, k2=0.7, scale=0.66)

def distort_barrel_high(img_h, img_w):
    return distort_barrel(img_h, img_w, k1=2.5, k2=2.5, scale=0.35)
